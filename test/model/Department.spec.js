...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MergeAtsApi.Department();
  });
  ...
  describe('Department', function() {
    it('should create an instance of Department', function() {
      ...
      //var instane = new MergeAtsApi.Department();
      //expect(instance).to.be.a(MergeAtsApi.Department);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MergeAtsApi.Department();
