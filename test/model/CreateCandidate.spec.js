...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MergeAtsApi.CreateCandidate();
  });
  ...
  describe('CreateCandidate', function() {
    it('should create an instance of CreateCandidate', function() {
      // uncomment below and update the code to test CreateCandidate
      //var instane = new MergeAtsApi.CreateCandidate();
      //expect(instance).to.be.a(MergeAtsApi.CreateCandidate);
    });

    it('should have the property firstName (base name: "first_name")', function() {
      // uncomment below and update the code to test the property firstName
      //var instance = new MergeAtsApi.CreateCandidate();
