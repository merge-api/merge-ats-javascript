...
let opts = {
  ...
  'createScheduledInterview': new MergeAtsApi.CreateScheduledInterview() // CreateScheduledInterview | 
};
 ...
 **createScheduledInterview** | [**CreateScheduledInterview**](CreateScheduledInterview.md)|  | [optional] 
