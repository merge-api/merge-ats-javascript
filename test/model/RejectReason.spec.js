...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MergeAtsApi.RejectReason();
  });
  ...
  describe('RejectReason', function() {
    it('should create an instance of RejectReason', function() {
      ...
      //var instane = new MergeAtsApi.RejectReason();
      //expect(instance).to.be.a(MergeAtsApi.RejectReason);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MergeAtsApi.RejectReason();
