...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MergeAtsApi.RemoteUser();
  });
  ...
  describe('RemoteUser', function() {
    it('should create an instance of RemoteUser', function() {
      // uncomment below and update the code to test RemoteUser
      //var instane = new MergeAtsApi.RemoteUser();
      //expect(instance).to.be.a(MergeAtsApi.RemoteUser);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MergeAtsApi.RemoteUser();
