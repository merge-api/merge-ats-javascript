...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MergeAtsApi.Candidate();
  });
  ...
  describe('Candidate', function() {
    it('should create an instance of Candidate', function() {
      ...
      //var instane = new MergeAtsApi.Candidate();
      //expect(instance).to.be.a(MergeAtsApi.Candidate);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MergeAtsApi.Candidate();
