...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MergeAtsApi.JobInterviewStage();
  });
  ...
  describe('JobInterviewStage', function() {
    it('should create an instance of JobInterviewStage', function() {
      // uncomment below and update the code to test JobInterviewStage
      //var instane = new MergeAtsApi.JobInterviewStage();
      //expect(instance).to.be.a(MergeAtsApi.JobInterviewStage);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MergeAtsApi.JobInterviewStage();
