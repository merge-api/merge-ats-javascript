...
var _CreateRejectReason = _interopRequireDefault(require("../model/CreateRejectReason"));
...
var RejectReasonsApi = /*#__PURE__*/function () {
  ...
  */
  ...
  _createClass(RejectReasonsApi, [{
    key: "rejectReasonsCreate",
    value: function rejectReasonsCreate(xAccountToken, opts, callback) {
      opts = opts || {};
      var postBody = opts['createRejectReason']; // verify the required parameter 'xAccountToken' is set
      ...
      return this.apiClient.callApi('/reject-reasons', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback);
    }
    /**
