...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MergeAtsApi.DataPassthroughRequest();
  });
  ...
  describe('DataPassthroughRequest', function() {
    it('should create an instance of DataPassthroughRequest', function() {
      ...
      //var instane = new MergeAtsApi.DataPassthroughRequest();
      //expect(instance).to.be.a(MergeAtsApi.DataPassthroughRequest);
    });

    it('should have the property method (base name: "method")', function() {
      // uncomment below and update the code to test the property method
      //var instance = new MergeAtsApi.DataPassthroughRequest();
