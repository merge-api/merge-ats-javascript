...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MergeAtsApi.ModelOperation();
  });
  ...
  describe('ModelOperation', function() {
    it('should create an instance of ModelOperation', function() {
      ...
      //var instane = new MergeAtsApi.ModelOperation();
      //expect(instance).to.be.a(MergeAtsApi.ModelOperation);
    });
    ...
    it('should have the property modelName (base name: "model_name")', function() {
      ...
      //var instance = new MergeAtsApi.ModelOperation();
