...
* @readonly
*/
var OfferStatusEnum = /*#__PURE__*/function () {
  function OfferStatusEnum() {
    _classCallCheck(this, OfferStatusEnum);
  ...
  _createClass(OfferStatusEnum, null, [{
    key: "constructFromObject",
    value:
    /**
    * Returns a <code>OfferStatusEnum</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/OfferStatusEnum} The enum <code>OfferStatusEnum</code> value.
    */
...
exports["default"] = OfferStatusEnum;