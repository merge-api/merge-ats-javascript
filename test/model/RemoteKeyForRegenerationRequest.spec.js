...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MergeAtsApi.RemoteKeyForRegenerationRequest();
  });
  ...
  describe('RemoteKeyForRegenerationRequest', function() {
    it('should create an instance of RemoteKeyForRegenerationRequest', function() {
      ...
      //var instane = new MergeAtsApi.RemoteKeyForRegenerationRequest();
      //expect(instance).to.be.a(MergeAtsApi.RemoteKeyForRegenerationRequest);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new MergeAtsApi.RemoteKeyForRegenerationRequest();
