...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MergeAtsApi.Scorecard();
  });
  ...
  describe('Scorecard', function() {
    it('should create an instance of Scorecard', function() {
      ...
      //var instane = new MergeAtsApi.Scorecard();
      //expect(instance).to.be.a(MergeAtsApi.Scorecard);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MergeAtsApi.Scorecard();
