...
export default class UsersApi {
    ...
    */
    ...
    usersCreate(xAccountToken, opts, callback) {
      opts = opts || {};
      let postBody = opts['createRemoteUser'];
     ...
     */
    usersList(xAccountToken, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'xAccountToken' is set
      if (xAccountToken === undefined || xAccountToken === null) {
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = PaginatedRemoteUserList;
      return this.apiClient.callApi(
        '/users', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
     ...
     * data is of type: {@link module:model/RemoteUser}
     */
    usersRetrieve(xAccountToken, id, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'xAccountToken' is set
      if (xAccountToken === undefined || xAccountToken === null) {
