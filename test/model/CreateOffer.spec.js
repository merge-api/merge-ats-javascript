...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MergeAtsApi.CreateOffer();
  });
  ...
  describe('CreateOffer', function() {
    it('should create an instance of CreateOffer', function() {
      // uncomment below and update the code to test CreateOffer
      //var instane = new MergeAtsApi.CreateOffer();
      //expect(instance).to.be.a(MergeAtsApi.CreateOffer);
    });
    ...
    it('should have the property application (base name: "application")', function() {
      ...
      //var instance = new MergeAtsApi.CreateOffer();
