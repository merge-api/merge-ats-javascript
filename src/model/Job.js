    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('departments')) {
                obj['departments'] = convertRelatedObjectToType(data['departments'], Department);
            }
            if (data.hasOwnProperty('offices')) {
                obj['offices'] = convertRelatedObjectToType(data['offices'], Office);
            }
            if (data.hasOwnProperty('hiring_managers')) {
                obj['hiring_managers'] = convertRelatedObjectToType(data['hiring_managers'], RemoteUser);
            }
