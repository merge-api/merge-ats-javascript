 ...
 * @version 1.0
 */
var PaginatedCandidateList = /*#__PURE__*/function () {
  /**
  ...
  function PaginatedCandidateList() {
    _classCallCheck(this, PaginatedCandidateList);
  ...
  _createClass(PaginatedCandidateList, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('results')) {
          obj['results'] = _ApiClient["default"].convertToType(data['results'], [_Candidate["default"]]);
        }
      }
...
var _default = PaginatedCandidateList;
