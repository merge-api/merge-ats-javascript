...
var _CandidateRequest = _interopRequireDefault(require("../model/CandidateRequest"));
...
var CandidatesApi = /*#__PURE__*/function () {
  ...
  */
  ...
  _createClass(CandidatesApi, [{
    ...
    value: function candidatesCreate(xAccountToken, remoteUserId, opts, callback) {
      opts = opts || {};
      var postBody = opts['candidateRequest']; // verify the required parameter 'xAccountToken' is set
