...
var _CreateJob = _interopRequireDefault(require("../model/CreateJob"));
...
var JobsApi = /*#__PURE__*/function () {
  ...
  */
  ...
  _createClass(JobsApi, [{
    key: "jobsCreate",
    value: function jobsCreate(xAccountToken, opts, callback) {
      opts = opts || {};
      var postBody = opts['createJob']; // verify the required parameter 'xAccountToken' is set
      ...
      return this.apiClient.callApi('/jobs', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback);
    }
    /**
