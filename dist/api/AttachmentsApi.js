...
var _CreateAttachment = _interopRequireDefault(require("../model/CreateAttachment"));
...
var AttachmentsApi = /*#__PURE__*/function () {
  ...
  */
  ...
  _createClass(AttachmentsApi, [{
    ...
    value: function attachmentsCreate(xAccountToken, opts, callback) {
      opts = opts || {};
      var postBody = opts['createAttachment']; // verify the required parameter 'xAccountToken' is set
