...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MergeAtsApi.ApplicationsApi();
  });
  ...
  describe('ApplicationsApi', function() {
    ...
    describe('applicationsRetrieve', function() {
      it('should call applicationsRetrieve successfully', function(done) {
        //uncomment below and update the code to test applicationsRetrieve
        //instance.applicationsRetrieve(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
