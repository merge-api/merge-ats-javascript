...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MergeAtsApi.PatchedApplicationRequest();
  });
  ...
  describe('PatchedApplicationRequest', function() {
    it('should create an instance of PatchedApplicationRequest', function() {
      // uncomment below and update the code to test PatchedApplicationRequest
      //var instane = new MergeAtsApi.PatchedApplicationRequest();
      //expect(instance).to.be.a(MergeAtsApi.PatchedApplicationRequest);
    });
    ...
    it('should have the property remoteId (base name: "remote_id")', function() {
      ...
      //var instance = new MergeAtsApi.PatchedApplicationRequest();
