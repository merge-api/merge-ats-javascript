...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MergeAtsApi.SyncStatus();
  });
  ...
  describe('SyncStatus', function() {
    it('should create an instance of SyncStatus', function() {
      ...
      //var instane = new MergeAtsApi.SyncStatus();
      //expect(instance).to.be.a(MergeAtsApi.SyncStatus);
    });
    ...
    it('should have the property modelName (base name: "model_name")', function() {
      ...
      //var instance = new MergeAtsApi.SyncStatus();
