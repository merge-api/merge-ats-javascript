...
var _CreateActivity = _interopRequireDefault(require("../model/CreateActivity"));

var _PaginatedActivityList = _interopRequireDefault(require("../model/PaginatedActivityList"));
...
var ActivitiesApi = /*#__PURE__*/function () {
  ...
  */
  ...
  _createClass(ActivitiesApi, [{
    ...
    value: function activitiesCreate(xAccountToken, opts, callback) {
      opts = opts || {};
      var postBody = opts['createActivity']; // verify the required parameter 'xAccountToken' is set
      ...
      return this.apiClient.callApi('/activities', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback);
    }
    /**
    ...
    key: "activitiesList",
    value: function activitiesList(xAccountToken, opts, callback) {
      opts = opts || {};
      ...
      var contentTypes = [];
      var accepts = ['application/json'];
      var returnType = _PaginatedActivityList["default"];
      return this.apiClient.callApi('/activities', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback);
    }
    /**
    ...
    key: "activitiesRetrieve",
    value: function activitiesRetrieve(xAccountToken, id, opts, callback) {
      opts = opts || {};
      var postBody = null; // verify the required parameter 'xAccountToken' is set
      ...
      var accepts = ['application/json'];
      var returnType = _Activity["default"];
      return this.apiClient.callApi('/activities/{id}', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback);
    }
  }]);
