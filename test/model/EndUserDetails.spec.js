...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MergeAtsApi.EndUserDetails();
  });
  ...
  describe('EndUserDetails', function() {
    it('should create an instance of EndUserDetails', function() {
      ...
      //var instane = new MergeAtsApi.EndUserDetails();
      //expect(instance).to.be.a(MergeAtsApi.EndUserDetails);
    });
    ...
    it('should have the property endUserEmailAddress (base name: "end_user_email_address")', function() {
      ...
      //var instance = new MergeAtsApi.EndUserDetails();
