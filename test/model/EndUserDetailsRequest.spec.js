...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MergeAtsApi.EndUserDetailsRequest();
  });
  ...
  describe('EndUserDetailsRequest', function() {
    it('should create an instance of EndUserDetailsRequest', function() {
      ...
      //var instane = new MergeAtsApi.EndUserDetailsRequest();
      //expect(instance).to.be.a(MergeAtsApi.EndUserDetailsRequest);
    });
    ...
    it('should have the property endUserEmailAddress (base name: "end_user_email_address")', function() {
      ...
      //var instance = new MergeAtsApi.EndUserDetailsRequest();
