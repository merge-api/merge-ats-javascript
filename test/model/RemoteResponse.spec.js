...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MergeAtsApi.RemoteResponse();
  });
  ...
  describe('RemoteResponse', function() {
    it('should create an instance of RemoteResponse', function() {
      ...
      //var instane = new MergeAtsApi.RemoteResponse();
      //expect(instance).to.be.a(MergeAtsApi.RemoteResponse);
    });

    it('should have the property method (base name: "method")', function() {
      // uncomment below and update the code to test the property method
      //var instance = new MergeAtsApi.RemoteResponse();
