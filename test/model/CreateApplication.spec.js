...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MergeAtsApi.CreateApplication();
  });
  ...
  describe('CreateApplication', function() {
    it('should create an instance of CreateApplication', function() {
      // uncomment below and update the code to test CreateApplication
      //var instane = new MergeAtsApi.CreateApplication();
      //expect(instance).to.be.a(MergeAtsApi.CreateApplication);
    });
    ...
    it('should have the property candidate (base name: "candidate")', function() {
      ...
      //var instance = new MergeAtsApi.CreateApplication();
