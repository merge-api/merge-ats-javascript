...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MergeAtsApi.OfficesApi();
  });
  ...
  describe('OfficesApi', function() {
    ...
    describe('officesList', function() {
      it('should call officesList successfully', function(done) {
        ...
        //instance.officesList(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('officesRetrieve', function() {
      it('should call officesRetrieve successfully', function(done) {
        //uncomment below and update the code to test officesRetrieve
        //instance.officesRetrieve(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
