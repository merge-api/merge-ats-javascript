...
var _CreateOffer = _interopRequireDefault(require("../model/CreateOffer"));
...
var OffersApi = /*#__PURE__*/function () {
  ...
  */
  ...
  /**
   * Callback function to receive the result of the offersCreate operation.
   * @callback module:api/OffersApi~offersCreateCallback
   ...
   * @param {module:model/CreateOffer} opts.createOffer 
   * @param {module:api/OffersApi~offersCreateCallback} callback The callback function, accepting three arguments: error, data, response
  ...
  _createClass(OffersApi, [{
    key: "offersCreate",
    value: function offersCreate(xAccountToken, opts, callback) {
      opts = opts || {};
      var postBody = opts['createOffer']; // verify the required parameter 'xAccountToken' is set

      if (xAccountToken === undefined || xAccountToken === null) {
        throw new Error("Missing the required parameter 'xAccountToken' when calling offersCreate");
      }
      ...
      return this.apiClient.callApi('/offers', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback);
    }
    /**
