...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MergeAtsApi.LinkToken();
  });
  ...
  describe('LinkToken', function() {
    it('should create an instance of LinkToken', function() {
      ...
      //var instane = new MergeAtsApi.LinkToken();
      //expect(instance).to.be.a(MergeAtsApi.LinkToken);
    });
    ...
    it('should have the property linkToken (base name: "link_token")', function() {
      ...
      //var instance = new MergeAtsApi.LinkToken();
