...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MergeAtsApi.EeocsApi();
  });
  ...
  describe('EeocsApi', function() {
    ...
    describe('eeocsList', function() {
      it('should call eeocsList successfully', function(done) {
        ...
        //instance.eeocsList(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('eeocsRetrieve', function() {
      it('should call eeocsRetrieve successfully', function(done) {
        //uncomment below and update the code to test eeocsRetrieve
        //instance.eeocsRetrieve(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
