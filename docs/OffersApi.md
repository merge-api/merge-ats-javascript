# MergeAtsApi.OffersApi

All URIs are relative to *https://api.merge.dev/api/ats/v1*

Method | HTTP request | Description
------------- | ------------- | -------------
[**offersCreate**](OffersApi.md#offersCreate) | **POST** /offers | 
...
> Offer offersCreate(xAccountToken, opts)
...
let opts = {
  ...
  'createOffer': new MergeAtsApi.CreateOffer() // CreateOffer | 
};
apiInstance.offersCreate(xAccountToken, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
 ...
 **createOffer** | [**CreateOffer**](CreateOffer.md)|  | [optional] 
