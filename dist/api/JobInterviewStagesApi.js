...
var _CreateJobInterviewStage = _interopRequireDefault(require("../model/CreateJobInterviewStage"));
...
var JobInterviewStagesApi = /*#__PURE__*/function () {
  ...
  */
  ...
  _createClass(JobInterviewStagesApi, [{
    key: "jobInterviewStagesCreate",
    value: function jobInterviewStagesCreate(xAccountToken, opts, callback) {
      opts = opts || {};
      var postBody = opts['createJobInterviewStage']; // verify the required parameter 'xAccountToken' is set
      ...
      return this.apiClient.callApi('/job-interview-stages', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback);
    }
    /**
