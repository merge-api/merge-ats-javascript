...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MergeAtsApi.CreateRemoteUser();
  });
  ...
  describe('CreateRemoteUser', function() {
    it('should create an instance of CreateRemoteUser', function() {
      // uncomment below and update the code to test CreateRemoteUser
      //var instane = new MergeAtsApi.CreateRemoteUser();
      //expect(instance).to.be.a(MergeAtsApi.CreateRemoteUser);
    });

    it('should have the property firstName (base name: "first_name")', function() {
      // uncomment below and update the code to test the property firstName
      //var instance = new MergeAtsApi.CreateRemoteUser();
