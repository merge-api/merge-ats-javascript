...
export default class EeocsApi {
    ...
    */
     ...
     */
    eeocsCreate(xAccountToken, opts, callback) {
      opts = opts || {};
      let postBody = opts['EEOC'];
     ...
     */
    eeocsList(xAccountToken, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'xAccountToken' is set
      if (xAccountToken === undefined || xAccountToken === null) {
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = PaginatedEEOCList;
      return this.apiClient.callApi(
        '/eeocs', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
     ...
     * data is of type: {@link module:model/EEOC}
     */
    eeocsRetrieve(xAccountToken, id, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'xAccountToken' is set
      if (xAccountToken === undefined || xAccountToken === null) {
