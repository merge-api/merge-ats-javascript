...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MergeAtsApi.ScheduledInterview();
  });
  ...
  describe('ScheduledInterview', function() {
    it('should create an instance of ScheduledInterview', function() {
      // uncomment below and update the code to test ScheduledInterview
      //var instane = new MergeAtsApi.ScheduledInterview();
      //expect(instance).to.be.a(MergeAtsApi.ScheduledInterview);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MergeAtsApi.ScheduledInterview();
